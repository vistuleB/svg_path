...
- When adding or regenerating Markdown figures:
  ...
  5. If the user needs to inspect new or regenerated README figures, ask for permission to push `markdown-assets` as part of the same task before telling them the figures are ready to view. Do not leave the README pointing at an unpushed asset and then ask the user to inspect it.
