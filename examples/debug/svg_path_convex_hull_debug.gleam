// Parked convex hull scratch harness.
//
// This file is intentionally commented out. It was originally kept at
// `src/svg_path_convex_hull_debug.gleam`, where it could call private/package
// development helpers while prototyping segment hull behavior. Keep it here as
// a reference, and move it back under `src` or update the private calls when you
