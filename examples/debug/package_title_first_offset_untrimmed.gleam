//// Full package-title first-offset untrimmed probe.
...
const output = "examples/debug/package_title_first_offset_untrimmed.svg"
...
fn render(
  ...
  let boxes = path_boxes([source, untrimmed_first_offset, trimmed_first_offset])
