//// First-offset arrangement graph probe for package_title.svg.
...
const output = "examples/debug/package_title_first_offset_arrangement.svg"

const zoom_output = "examples/debug/package_title_first_offset_arrangement_256_257_zoom.svg"
...
pub fn main() -> Nil {
  ...
  let assert Ok(bands) =
    single_offset_bands(svg_path.path_subpaths(source), options, [])
  ...
  write_file(
    output,
    render(source, untrimmed, colored_edges, survivor_ids, first_round_burn_ids),
  )
  write_file(
    zoom_output,
    render_zoom(
