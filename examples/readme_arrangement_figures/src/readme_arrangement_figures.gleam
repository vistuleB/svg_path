...
fn zero_length_closepath_probe() -> String {
  ...
  let labels = [
    svg.Text("M only", probe_heading_style(), svg_path.Point(90.0, 25.0), 12.0),
    svg.Text(
    ...
    svg.Text("M only", probe_heading_style(), svg_path.Point(90.0, 205.0), 12.0),
    svg.Text(
      "M then Z",
      probe_heading_style(),
    ...
    svg.Text("M 90,50", probe_code_style(), svg_path.Point(90.0, 78.0), 10.0),
    svg.Text(
      "M 260,50 L 260,50",
      probe_code_style(),
    ...
    svg.Text("M 90,120", probe_code_style(), svg_path.Point(90.0, 148.0), 10.0),
    svg.Text(
      "M 260,120 L 260,120",
      probe_code_style(),
    ...
    svg.Text("M 90,230", probe_code_style(), svg_path.Point(90.0, 258.0), 10.0),
    svg.Text(
      "M 260,230 Z",
      probe_code_style(),
    ...
    svg.Text("M 90,300", probe_code_style(), svg_path.Point(90.0, 328.0), 10.0),
    svg.Text(
      "M 260,300 Z",
      probe_code_style(),
