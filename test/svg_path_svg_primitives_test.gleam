...
import svg_path/svg_primitives
...
pub fn circle_converts_to_svg_equivalent_path_test() {
  let assert Ok(subpath) = svg_primitives.circle(cx: 10.0, cy: 20.0, r: 5.0)
...
pub fn ellipse_converts_to_svg_equivalent_path_test() {
  let assert Ok(subpath) =
    svg_primitives.ellipse(cx: 10.0, cy: 20.0, rx: 7.0, ry: 3.0)
...
pub fn line_converts_to_subpath_test() {
  let assert Ok(subpath) =
    svg_primitives.line(x1: 1.0, y1: 2.0, x2: 3.0, y2: 4.0)
...
pub fn invalid_dimensions_return_errors_test() {
  assert svg_primitives.rect(
    ...
    == Error(svg_primitives.InvalidRectWidth(-1.0))

  assert svg_primitives.circle(cx: 0.0, cy: 0.0, r: -1.0)
    == Error(svg_primitives.InvalidCircleRadius(-1.0))

  assert svg_primitives.ellipse(cx: 0.0, cy: 0.0, rx: 1.0, ry: -1.0)
    == Error(svg_primitives.InvalidEllipseRadiusY(-1.0))
}
...
pub fn disabled_rendering_returns_error_test() {
  assert svg_primitives.rect(
    ...
    == Error(svg_primitives.DisabledRendering)

  assert svg_primitives.circle(cx: 0.0, cy: 0.0, r: 0.0)
    == Error(svg_primitives.DisabledRendering)

  assert svg_primitives.ellipse(cx: 0.0, cy: 0.0, rx: 1.0, ry: 0.0)
    == Error(svg_primitives.DisabledRendering)
}

pub fn invalid_point_lists_return_core_errors_test() {
  assert svg_primitives.polyline([])
    == Error(svg_primitives.Core(svg_path.EmptySubpath))

  assert svg_primitives.polygon([svg_path.point(1.0, 2.0)])
    == Error(svg_primitives.Core(svg_path.EmptySubpath))
}
