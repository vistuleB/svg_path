...
pub fn subpath_untrimmed_offsets_open_polyline_with_default_miter_limit_test() {
  let subpath =
    svg_path.subpath_assert_polyline([
      svg_path.Point(0.0, 0.0),
      svg_path.Point(10.0, 0.0),
