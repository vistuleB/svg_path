...
pub fn subpath_can_be_built_from_empty_test() {
  ...
  assert svg_path.subpath_start(subpath) == start
  assert svg_path.subpath_end(subpath) == end
}
...
pub fn subpath_open_clears_closed_state_without_changing_segments_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let segments = [
    svg_path.Line(start: a, end: b),
  ...
  let opened = svg_path.subpath_open(closed)

  assert !svg_path.subpath_is_closed(opened)
  assert svg_path.subpath_segments(opened) == segments
}

pub fn subpath_open_accepts_open_and_empty_subpaths_test() {
  ...
  assert svg_path.subpath_open(empty) == empty
  assert svg_path.subpath_open(open_subpath) == open_subpath
}

pub fn subpath_open_opens_subpath_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let closed =
    svg_path.subpath_assert([
...
pub fn subpath_close_closes_matching_subpath_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let subpath =
    svg_path.subpath_assert([
...
pub fn subpath_close_rejects_uncloseable_subpath_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  ...
  assert svg_path.subpath_close(subpath)
    == Error(svg_path.Discontinuous(
      previous_index: 1,
      next_index: 0,
      expected: a,
...
pub fn set_closed_with_wiggle_true_rejects_gaps_beyond_tolerance_test() {
  ...
  assert svg_path.subpath_close_with(subpath, policy: svg_path.Wiggle)
    == Error(svg_path.Discontinuous(
      previous_index: 1,
      next_index: 0,
      expected: a,
...
pub fn subpath_open_is_idempotent_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let closed =
    svg_path.subpath_assert([
  ...
  assert !svg_path.subpath_is_closed(opened)
  assert svg_path.subpath_open(opened) == opened
}
...
pub fn subpath_is_empty_detects_move_only_subpath_test() {
  ...
  assert !svg_path.subpath_is_empty(svg_path.subpath_assert([line]))
}
...
pub fn splice_with_wiggle_reconciles_tiny_endpoint_gaps_test() {
  ...
  assert svg_path.subpath_end(spliced) == c
...
pub fn subpath_with_custom_wiggle_tolerance_accepts_larger_gap_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let c = svg_path.Point(10.1, 0.0)
  let d = svg_path.Point(20.0, 0.0)
  ...
  let assert Ok(subpath) =
    svg_path.subpath_with(
      ...
      policy: svg_path.wiggle_with(0.2),
    )
...
pub fn subpath_with_wiggle_bridges_misaligned_vertical_lines_test() {
  let a = svg_path.Point(0.0, 0.0)
...
pub fn subpath_with_wiggle_bridges_misaligned_horizontal_lines_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
...
pub fn join_with_wiggle_reconciles_tiny_endpoint_gap_test() {
  ...
  assert svg_path.subpath_start(joined) == a
  assert svg_path.subpath_end(joined) == c
...
pub fn subpath_with_custom_empty_replacement_deletes_both_segments_test() {
  ...
  assert svg_path.subpath_start(subpath) == e
}
...
pub fn custom_policy_receives_closing_join_flag_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let c = svg_path.Point(10.0, 10.0)
  let subpath =
  ...
  assert svg_path.subpath_is_closed(closed)
  assert svg_path.subpath_end(closed) == a
}
...
pub fn set_closed_with_custom_rejects_invalid_results_test() {
  ...
  assert svg_path.subpath_close_with(
      subpath,
...
pub fn set_closed_with_custom_empty_replacement_deletes_last_segment_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let c = svg_path.Point(10.0, 10.0)
  let subpath =
...
pub fn subpath_close_empty_subpath_closes_test() {
  let subpath = svg_path.subpath_empty(at: svg_path.Point(0.0, 0.0))

  assert svg_path.subpath_close(subpath)
    == Ok(svg_path.subpath_assert_close(subpath))
}

pub fn subpath_close_discontinuous_error_reports_last_to_first_indices_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
...
pub fn assert_subpath_close_closes_matching_endpoints_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let subpath =
    svg_path.subpath_assert([
  ...
  let closed = svg_path.subpath_assert_close(subpath)
...
pub fn open_at_rotates_a_closed_subpath_to_start_at_parameter_test() {
  ...
  assert svg_path.subpath_end(opened) == b
}
...
pub fn set_closed_with_wiggle_closes_misaligned_vertical_lines_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(0.0, 10.0)
  ...
  let assert Ok(closed) =
    svg_path.subpath_close_with(subpath, policy: svg_path.Wiggle)
  assert svg_path.subpath_is_closed(closed)
  let assert [_first, _second, _third, last] = svg_path.subpath_segments(closed)
  assert svg_path.segment_end(last) == a
}

pub fn set_closed_with_wiggle_closes_misaligned_horizontal_lines_test() {
  let a = svg_path.Point(0.0, 0.0)
  let b = svg_path.Point(10.0, 0.0)
  let c = svg_path.Point(0.0000000001, 0.0000000001)
...
fn result_try_set_closed_with_wiggle(
  ...
  case result_subpath {
    Ok(subpath) -> svg_path.subpath_close_with(subpath, policy: svg_path.Wiggle)
    Error(error) -> Error(error)
  }
}
