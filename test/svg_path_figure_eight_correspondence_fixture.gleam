...
const experiment_output_path = "examples/debug/figure_eight_band_correspondence_blocks_experiment.svg"

pub fn main() {
  let _ = ensure_dir(output_path)
  let _ = write_file(output_path, figure_eight_correspondence_blocks())
  let _ = ensure_dir(experiment_output_path)
  let _ =
    write_file(
      experiment_output_path,
      figure_eight_band_correspondence_blocks_experiment(),
    )
  Nil
}

pub fn figure_eight_band_correspondence_blocks_experiment() -> String {
